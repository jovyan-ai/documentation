...
- [Custom Modes](/customization/custom-modes) - Create modes that use MCP tools
- [Rules & Workflows](/customization/rules-workflows) - Combine rules with MCP
- [Settings](/customization/settings) - MCP auto-approval options
