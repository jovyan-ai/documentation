...
* **Use @ mentions** - Reference files and data directly with `@filename`. Add relevent context to the request improve the quality of the outputs.
...
Now that you understand task creation and execution:

* Learn how to [Configure the AI Agent](./configure-ai-agent) to optimize performance
* Discover [Context Management](./context-management) techniques for better results

Ready to start? Open the chat panel and describe what data you want to explore!
